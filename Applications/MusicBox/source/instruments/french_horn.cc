...
#pragma GCC ivdep
    ...
    for (size_t i = 0; i < count; ++i) {
      ...
      double attack = std::min(1.0, t / 0.08);
      out_samples[i] *= attack * 0.7;
    }
  }
};

auto _ = RegisterInstrumentSpec<FrenchHornImpl>(
    "French Horn", "Winds & Brass", 0.14, false, 5.0, 27);
