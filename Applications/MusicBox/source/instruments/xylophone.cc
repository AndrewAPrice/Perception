...
#pragma GCC ivdep
    ...
    for (size_t i = 0; i < count; ++i) {
      ...
      double decay = std::exp(-6.5 * t / duration_seconds);
      double env = attack * decay;
      out_samples[i] *= env * 0.7;
    }
  }
};

auto _ = RegisterInstrumentSpec<XylophoneImpl>(
    "Xylophone", "Chromatic Percussion & Bells", 0.40, true, 3.5, 15);
