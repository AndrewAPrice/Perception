...
std::string GetPciDeviceName(uint8 base_class, uint8 sub_class, uint8 prog_if) {
  switch (base_class) {
      ...
      switch (sub_class) {
        ...
        case 0x01:
          switch (prog_if) {
            ...
            case 0x0A:
              return "ISA Compatibility mode IDE controller, supports both "
                     "channels switched to PCI native mode";
            case 0x0F:
              return "PCI native mode IDE controller, supports both channels "
                     "switched to ISA compatibility mode";
            case 0x80:
              return "ISA Compatibility mode-only IDE controller, supports bus "
                     "mastering";
            case 0x85:
              return "PCI native mode-only IDE controller, supports bus "
                     "mastering";
            case 0x8A:
              return "ISA Compatibility mode IDE controller, supports both "
                     "channels switched to PCI native mode, supports bus "
                     "mastering";
            case 0x8F:
              return "PCI native mode IDE controller, supports both channels "
                     "switched to ISA compatibility mode, supports bus "
                     "mastering";
          }
        case 0x02:
        ...
        case 0x06:
          switch (prog_if) {
            default:
              return "Serial ATA";
            case 0x00:
              return "Vendor Specific Interface (Serial ATA)";
            case 0x01:
              return "AHCI 1.0 (Serial ATA)";
            case 0x02:
              return "Serial Storage Bus (Serial ATA)";
          }
        case 0x07:
          switch (prog_if) {
            default:
            ...
            case 0x01:
              return "Serial Storage Bus (Serial Attached SCSI)";
          }
        case 0x08:
          switch (prog_if) {
            default:
            ...
            case 0x01:
              return "NVMHCI (Non-Volatile Memory Controller)";
            case 0x02:
      ...
      switch (sub_class) {
        ...
        case 0x04:
          switch (prog_if) {
            ...
            case 0x00:
              return "Normal Decode (PCI-to-PCI Bridge)";
            case 0x01:
              return "Subtractive Decode (PCI-to-PCI Bridge)";
          }
        case 0x05:
        ...
        case 0x08:
          switch (prog_if) {
            ...
            case 0x00:
              return "Transparent Mode (RACEway Bridge)";
            case 0x01:
              return "Endpoint Mode (RACEway Bridge)";
          }
        case 0x09:
          switch (prog_if) {
            default:
              return "PCI-to-PCI Bridge";
            case 0x40:
              return "Semi-Transparent PCI-to-PCI Bridge, Primary bus towards "
                     "host CPU";
            case 0x80:
    ...
    case 0x07:
      switch (sub_class) {
        default:
          return "Unknown Simple Communication Controller";
        case 0x00:
          switch (prog_if) {
            default:
              return "Serial Controller";
            case 0x00:
              return "8250-Compatible (Generic XT) Serial Controller";
            case 0x01:
        ...
        case 0x01:
          switch (prog_if) {
            default:
              return "IEEE 1284 or Parallel Port";
            case 0x00:
      ...
      switch (sub_class) {
        ...
        case 0x00:
          switch (prog_if) {
            ...
            case 0x00:
              return "Generic 8259-Compatible Programmable Interrupt "
                     "Controller";
            case 0x01:
              return "ISA-Compatible Programmable Interrupt Controller";
            case 0x02:
              return "EISA-Compatible Programmable Interrupt Controller";
            case 0x10:
    ...
    case 0x0C:
      switch (sub_class) {
        ...
        case 0x00:
          switch (prog_if) {
            default:
              return "FireWire (IEE 1394) Controller";
            case 0x00:
              return "Generic FireWire (IEE 1394) Controller";
            case 0x01:
              return "OHCI FireWire (IEE 1394) Controller";
          }
        case 0x01:
          return "ACCESS.bus";
        case 0x02:
    ...
    case 0x0E:
      switch (sub_class) {
        default:
          return "Unknown Intelligent I/O Controller";
        case 0x00:
          return "I20";
      }
    case 0x0F:
      switch (sub_class) {
        default:
          return "Unknown Satellite Communication Controller";
        case 0x01:
    ...
    case 0x11:
      switch (sub_class) {
        default:
          return "Unknown Data Acquistion or Signal Processing Controller";
        case 0x00:
          return "DPIO Modules";
        case 0x01:
