...
public:
	virtual void HandleLaunchApplication(
		::perception::ProcessId sender,
		Permebuf<::permebuf::perception::Launcher::LaunchApplicationRequest> request,
		PermebufMiniMessageReplier<::permebuf::perception::Launcher::LaunchApplicationResponse> responder) override;
