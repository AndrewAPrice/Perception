...
void fill_rectangle(size_t x, size_t y, size_t width, size_t height, uint32 colour,
	uint32 *buffer, size_t buffer_width, size_t buffer_height) {
	size_t start_x = x;
	size_t start_y = y;
	...
	size_t indx = buffer_width * start_y + start_x;
	size_t _x, _y;
	for(_y = start_y; _y != end_y; _y++) {
...
void fill_rectangle_alpha(size_t x, size_t y, size_t width, size_t height, uint32 colour,
	uint32 *buffer, size_t buffer_width, size_t buffer_height) {
