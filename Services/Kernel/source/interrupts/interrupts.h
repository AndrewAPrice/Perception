...
constexpr int kNumberOfInterrupts = 16;
...
struct MessageToFireOnInterrupt {
  ...
  containers::LinkedListNode node_in_interrupt;
...
void RegisterMessageToSendOnInterrupt(size_t interrupt_number, processes::Process* process,
...
// Unregisters all interrupt messages for a process.
void UnregisterAllMessagesToFireOnInterruptForProcess(processes::Process* process);
