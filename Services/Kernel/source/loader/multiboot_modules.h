...
// Length of a multiboot module name in 64-bit words.
constexpr size_t kModuleNameWords = 10;

// Maximum length of a multiboot module name in characters.
constexpr size_t kModuleNameLength = kModuleNameWords * 8;
...
void LoadNextMultibootModuleIntoProcess(processes::Process* process,
