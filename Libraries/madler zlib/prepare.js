...
function copyFilesInDirectory(from, to, extension) {
	...
	for (let i = 0; i < filesInDirectory.length; i++) {
		...
		if (!fileStats.isDirectory() &&
			...
			(!extension && (fileExtension == '.c' || fileExtension == '.h'))) {
...
filesToIgnore['source/zlib.h'] = true;
filesToIgnore['source/zconf.h'] = true;

copyFilesInDirectory('third_party', 'source');
copyFile('third_party/zlib.h', 'public/zlib.h');
copyFile('third_party/zconf.h', 'public/zconf.h');
