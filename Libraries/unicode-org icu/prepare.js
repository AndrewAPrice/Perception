...
const acceptableExtensions = {'.c':1, '.cpp':1, '.h':1};
...
copyFilesInDirectory('third_party/icu4c/source/common/', 'source/common');
copyFilesInDirectory('third_party/icu4c/source/common/unicode', 'public/unicode', '.h');
copyFilesInDirectory('third_party/icu4c/source/i18n/', 'source/common');
copyFilesInDirectory('third_party/icu4c/source/i18n/unicode', 'public/unicode', '.h');
copyFilesInDirectory('third_party/icu4c/source/layoutex/', 'source/common');
copyFilesInDirectory('third_party/icu4c/source/layoutex/layout', 'public/layout', '.h');
